...
class TestGetMetadata:
    def test_missing_layer(self):
        ...
        with pytest.raises(ValueError, match="Layer not specified"):
            get_geometry_and_metadata("", data)
    ...
    def test_invalid_layer(self):
        ...
        with pytest.raises(KeyError):
            get_geometry_and_metadata("invalid_layer", data)
    ...
    def test_missing_province(self):
        ...
        with pytest.raises(ValueError):
            get_geometry_and_metadata("parcela", data)
    ...
    def test_missing_enclosure_recinto_layer(self):
        ...
        with pytest.raises(ValueError):
            get_geometry_and_metadata("recinto", data)
